//! https://github.com/solana-labs/solana-program-library/blob/master/examples/rust/transfer-tokens/tests/functional.rs
...
use {
    ...
    solana_lesson_transfer_tokens::processor::process_instruction,
